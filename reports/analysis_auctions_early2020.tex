...
\begin{table}[h]
    \centering
    \input{../results/tables/auctions_level_mat30_loan1_all.tex}
...
\begin{table}[h]
  \centering
  \input{../results/tables/auctions_level_mat30_loan1_jan-feb.tex}
...
\begin{table}[h]
  \centering
  \input{../results/tables/auctions_level_mat30_loan1_mar-apr.tex}
...
\begin{table}[h]
  \centering
  \input{../results/tables/auctions_coupon__mat30_loan1.tex}
...
%    \begin{minipage}{\textwidth}
%       \footnotesize{\textit{Notes:} The figure shows a time series of auction outcomes for Conforming loans with a 30-year maturity. The vertical line is March 1. For reference, Bloomberg TBA prices are aggregated for all forward months and coupons between 2.5, 3, and 3.5. } 
%       \end{minipage}
% \end{figure}
